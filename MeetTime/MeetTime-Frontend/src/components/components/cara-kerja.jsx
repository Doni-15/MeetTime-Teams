...
export function CaraKerja() {
    return(
        <>
            <section className="bg-[var(--color-warning)] border border-[var(--color-warning-content)] px-5 pt-3 pb-10 rounded-xl">
                <div className="flex justify-between items-center text-black">
                    <h1 className="font-semibold text-xl">Bagaimana cara kerjanya?</h1>
                    <ExclamationCircleIcon className="size-8 text-[var(--color-error)]" />                 
                </div>
